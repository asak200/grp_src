...
class UGVVisionNavigator(Node):
    def __init__(self):
        ...
        self.k_vfg = 2.0          # VFG Convergence gain
        self.k_apf = 50.0         # APF Repulsion gain
    ...
    def odom_callback(self, msg: Odometry):
        # Using your MATLAB dirty trick: Extracting Yaw from position.z
    ...
    def control_loop(self):
        ...
        v_mag = math.sqrt(total_x**2 + total_y**2)
        v_cmd = min(v_mag, self.v_max)
        ...
        self.get_logger().info(f"CMD -> v: {v_cmd:.2f}, w: {cmd.angular.z:.2f} | Dist: {dist_to_goal:.1f}m", throttle_duration_sec=0.5)
